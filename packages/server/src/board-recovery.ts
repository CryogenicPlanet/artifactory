/** This document does not depend on the missing board bundle. Every mutation goes directly to boot. */
export const boardRecovery = `<!doctype html><html lang="en"><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>comms recovery</title>
...
<h1>Board build unavailable</h1><p>Revert the last app source change. Messages, pages and identities are preserved. Pending edits must be resolved first; another editor’s lock is not broken.</p>
