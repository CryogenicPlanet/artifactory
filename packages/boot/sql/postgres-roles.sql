...
CREATE ROLE comms_boot LOGIN PASSWORD :'boot_password'
  NOSUPERUSER CREATEDB NOCREATEROLE INHERIT NOREPLICATION NOBYPASSRLS;
CREATE ROLE comms_app LOGIN PASSWORD :'app_password'
  NOSUPERUSER NOCREATEDB NOCREATEROLE INHERIT NOREPLICATION NOBYPASSRLS;
-- Only boot inherits app ownership; never grant boot membership to app.
GRANT comms_app TO comms_boot WITH INHERIT TRUE, SET TRUE;
