-- Exported from the historical v18 initializer. See README.md; do not regenerate from current code.
...
CREATE TABLE backups(id TEXT PRIMARY KEY,path TEXT NOT NULL,reason TEXT NOT NULL,bytes INTEGER NOT NULL,taken_at INTEGER NOT NULL, published_through INTEGER, generation INTEGER, legacy_store_id TEXT, engine TEXT NOT NULL DEFAULT 'sqlite' CHECK(engine IN ('sqlite','pg','mysql')));
...
CREATE TABLE edit_lock (
		...
		, reset_pin INTEGER NOT NULL DEFAULT 0 CHECK(reset_pin IN (0,1,2)));
...
INSERT INTO "seq"("singleton","next","published_through","pending_id","pending_attempt","pending_from","pending_to") VALUES(1,1,0,NULL,NULL,NULL,NULL);
