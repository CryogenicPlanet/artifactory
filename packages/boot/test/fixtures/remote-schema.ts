...
await Effect.runPromise(
	Effect.gen(function* () {
		...
		yield* initializeBootTables(sql, settings.engine);
		{
			...
			yield* sql`INSERT INTO passkey_codes(id,selector,hash,origin,failures,locked_until,proven,expires_at,created_at) VALUES ('code','ABCDEF123456',${"a".repeat(64)},NULL,0,0,0,1,1)`;
